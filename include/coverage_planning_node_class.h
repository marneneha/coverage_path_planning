...
namespace ns_boustrophedon{
    class coverage_planning_node_class : public nodelet::Nodelet{
        ...
        coordinates_node*                       traversal_prev_coordinate1;
        coordinates_node*                       traversal_prev_coordinate2;
        coordinates_node*                       traversal_next_coordinate1;
        coordinates_node*                       traversal_next_coordinate2;  
        ...
        int concavity_indentifier(coordinates_node* start_node, coordinates_node* end_node);
